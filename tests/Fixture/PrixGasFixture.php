 ...
 * PrixGasFixture
 */
class PrixGasFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        '_indexes' => [
            'prix_gas_lieu' => ['type' => 'index', 'columns' => ['lieu_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'prix_gas_lieu' => ['type' => 'foreign', 'columns' => ['lieu_id'], 'references' => ['lieu_gas', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
