    ...
    <body>
        <nav class="top-bar expanded" data-topbar role="navigation">
            <ul class="title-area large-3 medium-4 columns">
                <li class="name">
                    <h1><?= $this->Html->link(__('RefFuelType') . ' v0.0.1', '/'); ?><?php // echo " - " . $this->fetch('title');          ?></h1>
                </li>
            </ul>
            <div class="top-bar-section">

                <ul class="right">
                    <li><?= $this->Html->link(__('Listes liées'), ['controller' => 'NomGas', 'action' => 'add']) ?></li>
                    <li><?= $this->Html->link(__('Autocomplétion'), ['controller' => 'RefFuelTypes', 'action' => 'add']) ?></li>
                    <li><?= $this->Html->link(__('A propos'), ['controller' => 'Apropos', 'action' => 'index']) ?></li>
                    <li><?= $this->Html->link(__('Monopage'), ['controller' => 'LieuGas', 'action' => 'index']) ?></li>
                    <li><?= $this->Html->link(__('Routage Admin'), ['prefix' => 'admin', 'controller' => 'LieuGas', 'action' => 'index']) ?></li>
                    <?php
